...
networking:
  ...
  - cidr: 10.128.0.0/14
    hostPrefix: 23
  networkType: OVNKubernetes #OpenShiftSDN 수정
  serviceNetwork:
  - 172.30.0.0/16
platform:
  none: {}
...
sshKey: 'ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIBzebQ96gWEQv5Ui/mzkNzQT07wWg3+3eDtIEhrH+pLQ root@ocp.ocp4.okd.io'
EOF
